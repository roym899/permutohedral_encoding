...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  py::class_<EncodingWrapper, std::shared_ptr<EncodingWrapper>>(
      m, "EncodingWrapper")
      .def_static(
          "create",
          &EncodingWrapper::create<
              const int, const int,
              const EncodingFixedParams&>)  // for templated methods like this
      ...
      .def("double_backward_from_positions",
           &EncodingWrapper::double_backward_from_positions);
}
